...
var grep = {ajax:{}};
grep.ajax.getRes = function() {
  console.log("start req");
  return jayq.core.ajax.call(null, "/game/farm_town_info?town_id\x3d34273\x26action\x3dclaim_load\x26h\x3d037236f1a75", new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null, "dataType", "dataType", 1069893619), "json", new cljs.core.Keyword(null, "type", "type", 1174270348), "POST", new cljs.core.Keyword(null, "data", "data", -232669377), "json\x3d%7B%22target_id%22%3A%229251%22%2C%22claim_type%22%3A%22normal%22%2C%22time%22%3A300%2C%22town_id%22%3A34273%2C%22nl_init%22%3Atrue%7D", 
  new cljs.core.Keyword(null, "success", "success", 1890645906), function(a) {
    return console.log(a.json);
  }], null));
};
grep.ajax.getData = function(a, b) {
  console.log("start req");
  return jayq.core.ajax.call(null, [cljs.core.str("/game/data?town_id\x3d"), cljs.core.str((new cljs.core.Keyword(null, "townId", "townId", -1931036373)).cljs$core$IFn$_invoke$arity$1(a)), cljs.core.str("\x26action\x3dget\x26h\x3d"), cljs.core.str((new cljs.core.Keyword(null, "csrf", "csrf", 1252357240)).cljs$core$IFn$_invoke$arity$1(a))].join(""), new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null, "dataType", "dataType", 1069893619), "json", new cljs.core.Keyword(null, "type", 
  "type", 1174270348), "POST", new cljs.core.Keyword(null, "data", "data", -232669377), [cljs.core.str("json\x3d%7B%22types%22%3A%5B%7B%22type%22%3A%22map%22%2C%22param%22%3A%7B%22x%22%3A14%2C%22y%22%3A1%7D%7D%2C%7B%22type%22%3A%22bar%22%7D%2C%7B%22type%22%3A%22backbone%22%7D%5D%2C%22town_id%22%3A"), cljs.core.str((new cljs.core.Keyword(null, "townId", "townId", -1931036373)).cljs$core$IFn$_invoke$arity$1(a)), cljs.core.str("%2C%22nl_init%22%3Afalse%7D")].join(""), new cljs.core.Keyword(null, "success", 
  "success", 1890645906), function(a) {
    return b.call(null, a);
  }], null));
};
grep.grep = {};
...
grep.grep.cData = cljs.core.js__GT_clj.call(null, grep.grep.Data, new cljs.core.Keyword(null, "keywordize-keys", "keywordize-keys", 1310784252), !0);
grep.grep.l = function(a) {
  return console.log(a);
};
grep.grep.jl = function(a) {
  return console.log(cljs.core.clj__GT_js.call(null, a));
};
grep.grep.init = function(a, b, c) {
  b = cljs.core.js__GT_clj.call(null, b);
  cljs.core.js__GT_clj.call(null, c);
  cljs.core.swap_BANG_.call(null, a, cljs.core.assoc, new cljs.core.Keyword(null, "csrf", "csrf", 1252357240), cljs.core.get.call(null, b, "csrfToken"), new cljs.core.Keyword(null, "townId", "townId", -1931036373), cljs.core.get.call(null, b, "townId"));
  return grep.grep.l.call(null, cljs.core.clj__GT_js.call(null, cljs.core.deref.call(null, a)));
};
grep.grep.initStatic = function(a) {
  var b = cljs.core.js__GT_clj.call(null, window.Game);
  return cljs.core.swap_BANG_.call(null, a, cljs.core.assoc, new cljs.core.Keyword(null, "csrf", "csrf", 1252357240), cljs.core.get.call(null, b, "csrfToken"), new cljs.core.Keyword(null, "townId", "townId", -1931036373), cljs.core.get.call(null, b, "townId"));
};
...
grep.grep.testajj = function(a, b) {
  console.log("start req");
  return jayq.core.ajax.call(null, "./api/res.json", new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null, "dataType", "dataType", 1069893619), "json", new cljs.core.Keyword(null, "type", "type", 1174270348), "POST", new cljs.core.Keyword(null, "async", "async", 1050769601), !1, new cljs.core.Keyword(null, "success", "success", 1890645906), function(b) {
    grep.grep.l.call(null, cljs.core.clj__GT_js.call(null, a));
    return a;
  }, new cljs.core.Keyword(null, "error", "error", -978969032), function(a) {
    return grep.grep.log.call(null, console, a);
  }], null));
};
grep.grep.getFarmList = function(a) {
  for (var b = cljs.core.PersistentVector.EMPTY;;) {
    if (1 > cljs.core.count.call(null, a)) {
      return b;
    }
    b = cljs.core.conj.call(null, b, (new cljs.core.Keyword(null, "farm_town_id", "farm_town_id", 1656833968)).cljs$core$IFn$_invoke$arity$1((new cljs.core.Keyword(null, "d", "d", 1972142424)).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null, a))));
    a = cljs.core.rest.call(null, a);
  }
};
grep.grep.getDataOfClass = function(a, b) {
  var c = (new cljs.core.Keyword(null, "collections", "collections", -2114643505)).cljs$core$IFn$_invoke$arity$1((new cljs.core.Keyword(null, "backbone", "backbone", 1943075380)).cljs$core$IFn$_invoke$arity$1((new cljs.core.Keyword(null, "json", "json", 1279968570)).cljs$core$IFn$_invoke$arity$1(a))), d = cljs.core.filterv.call(null, function(a) {
    return function(a) {
      return cljs.core._EQ_.call(null, cljs.core.get.call(null, a, new cljs.core.Keyword(null, "class_name", "class_name", 1946637862)), b);
    };
  }(c), c);
  return cljs.core.filter.call(null, function(a, b) {
    return function(a) {
      return cljs.core._EQ_.call(null, (new cljs.core.Keyword(null, "relation_status", "relation_status", -1336254268)).cljs$core$IFn$_invoke$arity$1((new cljs.core.Keyword(null, "d", "d", 1972142424)).cljs$core$IFn$_invoke$arity$1(a)), 1);
    };
  }(c, d), (new cljs.core.Keyword(null, "data", "data", -232669377)).cljs$core$IFn$_invoke$arity$1(cljs.core.get.call(null, d, 0)));
};
grep.grep.parseDat = function(a) {
  a = (new cljs.core.Keyword(null, "collections", "collections", -2114643505)).cljs$core$IFn$_invoke$arity$1((new cljs.core.Keyword(null, "backbone", "backbone", 1943075380)).cljs$core$IFn$_invoke$arity$1((new cljs.core.Keyword(null, "json", "json", 1279968570)).cljs$core$IFn$_invoke$arity$1(a)));
  var b = cljs.core.filterv.call(null, function(a) {
    return function(a) {
      return cljs.core._EQ_.call(null, cljs.core.get.call(null, a, new cljs.core.Keyword(null, "class_name", "class_name", 1946637862)), "FarmTownPlayerRelations");
    };
  }(a), a), b = cljs.core.filter.call(null, function(a, b) {
    return function(a) {
      return cljs.core._EQ_.call(null, (new cljs.core.Keyword(null, "relation_status", "relation_status", -1336254268)).cljs$core$IFn$_invoke$arity$1((new cljs.core.Keyword(null, "d", "d", 1972142424)).cljs$core$IFn$_invoke$arity$1(a)), 1);
    };
  }(a, b), (new cljs.core.Keyword(null, "data", "data", -232669377)).cljs$core$IFn$_invoke$arity$1(cljs.core.get.call(null, b, 0)));
  grep.grep.jl.call(null, a);
  grep.grep.jl.call(null, b);
  return grep.grep.jl.call(null, grep.grep.getFarmList.call(null, b));
};
grep.grep.initFarm = function(a, b) {
  var c = grep.grep.getFarmList.call(null, grep.grep.getDataOfClass.call(null, b, "FarmTownPlayerRelations"));
  return cljs.core.swap_BANG_.call(null, a, cljs.core.assoc, new cljs.core.Keyword(null, "farm", "farm", 1490097503), new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "farmList", "farmList", -469198675), c, new cljs.core.Keyword(null, "action_at", "action_at", -885458569), (new Date).getTime()], null));
};
grep.grep.pp = function(a) {
  grep.grep.l.call(null, cljs.core.clj__GT_js.call(null, a));
  return a;
};
grep.grep.qq = function(a) {
  grep.grep.l.call(null, "get data good");
  return grep.grep.l.call(null, a);
};
grep.grep.startBot = function() {
  return grep.grep.jl.call(null, grep.ajax.getData.call(null, grep.grep.initStatic.call(null, grep.grep.state), grep.grep.qq));
};
jayq.core.document_ready.call(null, grep.grep.startBot.call(null));
